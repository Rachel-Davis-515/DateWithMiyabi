                            ...
                            if (choice40 == 1) {
                                ...
                                if (choice41 == 1) {
                                    ...
                                    if (choice42 == 1) {
                                        ...
                                        second();
                                        String message122 = name + "，我们要试试吗？";
                                        spt(message122);
                                        System.out.println();
                                        second();
                                        System.out.println("在上面（1）在下面（2）没满18岁（3）");
                                        int choiceSex = scanner.nextInt();
                                        if (choiceSex == 1) {
                                            spt("唔……真的要这样吗……如果你开心的话。");
                                            System.out.println();
                                            second();
                                            System.out.println("×少女听见你的请求羞红了脸，随后顺从地躺在了你身下。");
                                            second();
                                            spt("嗯……请进来吧。让我获得我的第一次。");
                                            System.out.println();
                                            second();
                                            System.out.println("将手指伸进雅的身体（1）");
                                            int enter = scanner.nextInt();
                                            if (enter == 1) {
                                                System.out.println("×你将手指缓缓推进细嫩的甬道。");
                                                second();
                                                System.out.println("×嫣红的花蕊吐着清澈的蜜液，将你圆润的指甲打湿--一股甜香味弥漫开来。");
                                                second();
                                                System.out.println("×随着你的深入，少女的眉轻蹙起来，唇齿轻启，不自觉发出呻吟。");
                                                second();
                                                System.out.println("……（1）");
                                                int dt = scanner.nextInt();
                                                if (dt == 1) {
                                                    System.out.println("×这个时候的小雅真可爱啊。你调笑道。");
                                                    second();
                                                    spt("唔……不，好深……");
                                                    System.out.println();
                                                    second();
                                                    System.out.println("×雅终是忍不住动了情，开始主动迎合你的动作。");
                                                    second();
                                                    spt("嗯……再深一点，好舒服……");
                                                    second();
                                                    System.out.println();
                                                    System.out.println("×手指动作地越来越快，你一边在花心处抽插，");
                                                    second();
                                                    System.out.println("×一边用两指拨开小阴唇，揉弄起敏感的花蒂来。");
                                                    second();
                                                    spt("唔……喜欢，好喜欢啊……");
                                                    second();
                                                    System.out.println();
                                                    System.out.println("×少女眉眼含春，最终在抽插了几十下之后，尖叫着泄了出来。");
                                                    second();
                                                    spt("啊啊啊啊啊啊啊！！！！！");
                                                    second();
                                                    System.out.println();
                                                    System.out.println("×一股清亮的水柱从少女的两腿间倾泻而出，打湿了床单。");
                                                    second();
                                                    System.out.println("×高潮后的虚狩小姐透露着平日里从未见过的神色，眯眼笑着看你。");
                                                    second();
                                                    System.out.println("×白嫩的肌肤都透着粉红色，你不觉又看呆了。");
                                                    second();
                                                    spt("看什么呢，" + name);
                                                    second();
                                                    System.out.println();
                                                    System.out.println("×雅用脚尖勾了勾你的手臂，笑说。");
                                                    second();
                                                    spt("好想每晚都和绳匠小姐做这样的事哦……～");
                                                    System.out.println();
                                                    second();
                                            ...
                                            System.out.println();
                                            second();
                                            System.out.println("×刚提出请求，你就感受到雅开始主动回吻。");
                                            second();
                                            System.out.println("×带着冷香的唇舌愈发激烈地搅动，");
                                            second();
                                            System.out.println("×年轻的虚狩大人似乎试图将你扑倒。");
                                            second();
                                            System.out.println("×你轻轻摩挲着雅带有薄肌肉的小臂，");
                                            second();
                                            System.out.println("×矜持很快就在虚狩训练有素的力道中败下阵来。");
                                            second();
                                            System.out.println("×你感到一阵天旋地转，后脑勺枕在了柔软的床单上。");
                                            second();
                                            System.out.println("×被熟悉的气味包裹，你感到很安心，不由得细细端详面前人的脸。");
                                            second();
                                            System.out.println("×情欲沾染的红宝石眼睛，像是昨晚在梦里看见的那样……");
                                            second();
                                            System.out.println("……（1）");
                                            ...
                                            if (choices == 1) {
                                                ...
                                                System.out.println();
                                                second();
                                                System.out.println("×雅将食指伸进了你的甬道，打着圈儿细细扩张。");
                                                second();
                                                System.out.println("×有力的指尖时不时狠狠压上敏感点，");
                                                second();
                                                System.out.println("×雅一边在甬道里活动，一边用大拇指挑开包皮，");
                                                second();
                                                System.out.println("×逗弄嫣红色的一个小点。");
                                                second();
                                                spt("嗯……你的水好多……");
                                                System.out.println();
                                                spt("手掌都沾湿了。");
                                                ...
                                                System.out.println();
                                                second();
                                                System.out.println("×雅呢喃地说着，那些热烈的赞美让你脸红。");
                                                second();
                                                System.out.println("×随着她的动作，你感到自己仿佛海面上，");
                                                second();
                                                System.out.println("×一艘飘摇的小船。");
                                                second();
                                                System.out.println("×在情欲的浪潮中起起伏伏……");
                                                second();
                                                System.out.println("×任凭体内灵活的手指将你推上顶点。");
                                                second();
                                                spt("宝贝，别咬……叫出来，我爱听。");
                                                System.out.println();
                                                spt("绳匠小姐怎么吃的这样紧，是快到了吗……");
                                                System.out.println();
                                                second();
                                                System.out.println("×雅轻轻地拿开了你咬在嘴里的被角。");
                                                second();
                                                System.out.println("×婉转的呻吟不自觉地从口中溢出。");
                                                second();
                                                System.out.println("……唔（1）");
                                                int come = scanner.nextInt();
                                                if (come == 1) {
                                                    System.out.println("×你羞耻地转过头去。");
                                                    second();
                                                    spt("要到了吗，要不要更快一点？");
                                                    System.out.println();
                                                    second();
                                                    System.out.println("×雅有些坏心眼地问道。");
                                                    second();
                                                    System.out.println("×得到你肯定的答复之后，猛地加快了动作。");
                                                    second();
                                                    System.out.println("×指尖恰到好处地抠挖着敏感点，时不时整根没入。");
                                                    second();
                                                    System.out.println("×霎那间，快感从下体蔓延到全身。");
                                                    second();
                                                    System.out.println("×抽插十几下之后，你的大脑一片空白。");
                                                    second();
                                                    System.out.println("要到了……雅！（1）");
                                                    int going = scanner.nextInt();
                                                    if (going == 1) {
                                                        System.out.println("×你抓住雅的手臂，颤抖着到达了顶点。");
                                                        second();
                                                        spt("绳匠小姐……高潮的时候竟然这么可爱……");
                                                        System.out.println();
                                                        spt(" 好喜欢你……");
                                                        System.out.println();
                                                        second();
                                                        System.out.println("×雅，我也喜欢你。你这样回答到。");
                                                        second();
                                                        System.out.println("×雅宽慰地抱紧了你。");
                                                        second();
                                                        spt("以后，我们永远也不要分开了吧。");
                                                        second();
                                                        System.out.println();
                                            ...
                                            System.out.println();
                                            second();
                                            System.out.println("×星见雅沉默了几秒，然后显出懊恼的神色来。");
                                            second();
                                            spt("……身为虚狩，怎么能对一个未成年人提出如此无礼的要求……");
                                            System.out.println();
                                            second();
                                            System.out.println("×星见雅爱怜地摸了摸你的脸，然后轻轻吻了一下你的额头。");
                                            second();
                                            spt("没事哦，" + name + "，我等你哦");
                                            System.out.println();
                                            spt("在那之前，先做一些小孩子可以做的事好啦～");
                                            System.out.println();
                                            second();
